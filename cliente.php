...
<head>
    ...
    <title>Rick y Morti: La enciclopedia</title>
    <style>
...
if (isset($_GET["action"]) && isset($_GET["id"]) && $_GET["action"] == "get_datos_capitulo"){
    $app_info = file_get_contents('https://rickandmortyapi.com/api/episode/' . $_GET["id"]);
    ...
    <?php
      ...
      <?php $personaje = file_get_contents($character);
        ...
        ?>
        <tr><td>
        <a href="<?php echo "https://jomaexp.infinityfreeapp.com/rickymorty/cliente.php?action=get_datos_personaje&id=" . $personaje->id  ?>">
    ...
    <div class="volver">
        <a  href="https://jomaexp.infinityfreeapp.com/rickymorty/cliente.php" alt="volver a inicio">Volver a la lista de capítulos</a>
    </div>
    <br>
    <?php
...
entonces se va a mostrar los detalles del personaje con ese id junto a los capítulos
 donde aparece.*/
    ...
    $app_info = file_get_contents('https://rickandmortyapi.com/api/character/' . $_GET["id"]);
    $app_info = json_decode($app_info);
    /* Creamos un div que va a contener un título y una tabla.
    ...
    <?php
      ...
      <?php $episodio = file_get_contents($episod);
        ...
        ?>
        <tr><td>
        <a href="<?php echo "https://jomaexp.infinityfreeapp.com/rickymorty/cliente.php?action=get_datos_capitulo&id=" . $episodio->id  ?>">
...
<?php 
    ...
    <?php foreach($app_info->results as $result): ?>
        <tr><td>
        <a href="<?php echo "https://jomaexp.infinityfreeapp.com/rickymorty/cliente.php?action=get_datos_capitulo&id=" . $result->id ?>">
