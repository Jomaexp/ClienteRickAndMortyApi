...
if (isset($_GET["action"]) && isset($_GET["id"]) && $_GET["action"] == "get_datos_capitulo"){
    ...
    <?php
      ...
      <?php $personaje = file_get_contents($character);
        ...
        ?>
        <tr><td>
        <a href="<?php echo "http://localhost/dwes/tarea9/cliente.php?action=get_datos_personaje&id=" . $personaje->id  ?>">
    ...
    <div class="volver">
        <a  href="http://localhost/dwes/tarea9/cliente.php" alt="volver a inicio">Volver a la lista de capítulos</a>
    </div>
    <br>
    <?php
 ...
 donde aparece.*/
    ...
    <?php
      ...
      <?php $episodio = file_get_contents($episod);
        ...
        ?>
        <tr><td>
        <a href="<?php echo "http://localhost/dwes/tarea9/cliente.php?action=get_datos_capitulo&id=" . $episodio->id  ?>">
...
<?php 
    ...
    <?php foreach($app_info->results as $result): ?>
        <tr><td>
        <a href="<?php echo "http://localhost/DWES/TAREA9/cliente.php?action=get_datos_capitulo&id=" . $result->id ?>">
